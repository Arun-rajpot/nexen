...
#
#         new_set = set(json.dumps(d) for d in new_data)
#         old_set = set(json.dumps(d) for d in old_data)
#
...
#                 for entry in unique:
#                     f.write(entry + ",\n")
#             log(f"✅ {len(unique)} unique records written: {unique_file}")
#         else:
...
#
# def create_unique():
#     base_dir = r"D:\New_Rera\New_rera_project"
...
#
#             old_file = os.path.join(old_folder, f"New_Rera_{state_name}.txt")
